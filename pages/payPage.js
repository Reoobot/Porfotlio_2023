          ...
          <CardFront>
            ...
            <div className="relative grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                como React, Vite y Material-UI. Esta aplicación redefine la forma en que los profesionales y creativos presentan 
                sus habilidades, proyectos y experiencias a través de un diseño elegante y altamente funcional.
                </p>
                <div className="m-auto flex justify-center mt-8">
                      <Link href="/game" className="items-center">
                        <span className="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md text-xl font-medium shadow-lg">
                            Volver
                        </span>
                      </Link>
                      <Link href="/folioPage" className="items-center ml-3">
              ...
              <div className="m-auto px-5 p-5 relative">
                  <Image className="rounded-md w-full cursor-pointer mb-36" 
                        src="/images/pay.jpeg" 
                        alt="Imagen de la aplicación pay" 
                        width={500} 
                        height={300}/>
                  <div className="absolute inset-0 flex justify-center items-center mb-32">
                <Link href="https://pay-v6.vercel.app/" target="_blank" rel="noopener noreferrer">
